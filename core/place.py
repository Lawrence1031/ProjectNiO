...
class Place(pygame.sprite.Sprite):
	def __init__(self, scene, sName, map, x, y):
		...
		self.shapes["WARNING_DISABLE_HOVER"] = add_text_shape(shape.copy())
		pygame.draw.circle(shape, (50, 50, 255, 100), (25, 25), 25, 4) #호버 
		...
		self.shapes["EVENT1_DISABLE_HOVER"] = add_text_shape(shape.copy())
		pygame.draw.circle(shape, (50, 50, 255, 100), (25, 25), 25, 4) #호버 
		...
		self.shapes["EVENT2_DISABLE_HOVER"] = add_text_shape(shape.copy())
		pygame.draw.circle(shape, (50, 50, 255, 100), (25, 25), 25, 4) #호버 
