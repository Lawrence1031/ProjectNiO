...
class Result(Scene):
	...
	def update(self):
		try:
			...
			# 커서 변경.
			bHand = False
			bHand = self.btNext.collidepoint(pos)
			if bHand : pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
